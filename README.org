...
el blog [[https://www.glc.us.es/~jalonso/calculemus][Calculemus]] y su código en [[https://github.com/jaalonso/Calculemus2][GitHub]].
...
#+INCLUDE: "./src/Introduccion/Ejemplo_de_demostracion.org"
...
#+INCLUDE: "./src/Basicos/Asociativa_conmutativa_de_los_reales.org"
...
#+INCLUDE: "./src/Basicos/Ejercicio_sobre_aritmetica_real_1.org"
...
#+INCLUDE: "./src/Basicos/Ejercicio_sobre_aritmetica_real_2.org"
...
#+INCLUDE: "./src/Basicos/Ejemplo_de_rw_sobre_hipotesis.org"
...
+ [[https://raw.githubusercontent.com/madvorak/lean4-cheatsheet/main/lean-tactics.pdf][Lean 4 cheatsheet]]. ~ Martin Dvořák.
...
+ [[https://github.com/madvorak/lean3-tactic-lean4/blob/main/README.md][Reference sheet for people who know Lean 3 and want to write tactic-based proofs in Lean 4]]. ~ Martin Dvořák.
+ [[https://leanprover.github.io/theorem_proving_in_lean4/title_page.html][Theorem proving in Lean 4]]. ~ Jeremy Avigad, Leonardo de Moura, Soonho
